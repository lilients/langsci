...
<form class="pkp_form" id="uploadForm" action="#" method="post">
	{fbvFormArea id="file"}
		...
		{** Carola Fanselow: Current File Info weg
...
{** Carola Fanselow: Code zum Setzen der Vorauswahl und zum Auslösen des change-Events, damit der upload-Button enabled wird **}
<script type="text/javascript">
	...
	{literal}
		...
		document.getElementById("genreId").selectedIndex = "2";
